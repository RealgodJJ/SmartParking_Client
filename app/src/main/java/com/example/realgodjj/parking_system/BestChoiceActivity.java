...
//                + "\n" + totalTime + "\n" + parkFee);
        ...
        e_totalTime.setText(totalTime + "小时");
    ...
    private Handler handler = new Handler() {
        public void handleMessage(Message message) {
            switch (message.what) {
                case RESERVE_ERROR:
                    Toast.makeText(BestChoiceActivity.this, R.string.reserve_space_error, Toast.LENGTH_SHORT).show();
                    break;
                case RESERVE_SUCCESS:
                    Toast.makeText(BestChoiceActivity.this, R.string.reserve_space_success, Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
